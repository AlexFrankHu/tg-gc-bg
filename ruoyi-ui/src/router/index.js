...
export const constantRoutes = [
  ...
  {
    path: '/tg/webclient',
    component: () => import('@/views/tg/webclient/index'),
    hidden: true,
    meta: { title: 'Telegram Web Client' }
  },
  {
    path: '',
    component: Layout,
...
export const dynamicRoutes = [
  ...
  {
    path: '/tg/import-detail',
    component: Layout,
    hidden: true,
    permissions: ['tg:import:list'],
    children: [
      {
        path: '/tg/import/detail',
        component: () => import('@/views/tg/import/detail'),
        name: 'ImportDetail',
        meta: { title: '导入详情', activeMenu: '/tg/import' }
      }
    ]
  },
  {
    path: '/tg/contactImport-detail',
    component: Layout,
    hidden: true,
    permissions: ['tg:contactImport:list'],
    children: [
      {
        path: '/tg/contactImport/detail',
